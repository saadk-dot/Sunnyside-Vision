  ...
  return (
    <div style={{ paddingTop: 'var(--nav-h)', minHeight: '100vh' }}>
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '80px 32px' }}>
        <div style={{ fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.16em', color: 'var(--accent)', fontWeight: 600, marginBottom: 16 }}>Community Engagement Platform</div>
        ...
        <div style={{ display: 'flex', gap: 16 }}>
          <Link to="/" style={{ padding: '14px 32px', borderRadius: 8, background: 'var(--accent)', color: 'white', fontWeight: 600, fontSize: 15 }}>Explore the Map →</Link>
